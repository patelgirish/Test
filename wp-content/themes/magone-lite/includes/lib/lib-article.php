...
$MagOne_Article_Common_Fields = array(
	'title' => array(
		'label' => esc_html__('Title', 'magone-lite'),
		'description' => esc_html__('Title of Block', 'magone-lite'),
	),
	'title_url' => array(
		'label' => esc_html__('Title URL', 'magone-lite'), 
		'description' => esc_html__('URL for Title of Block. Leave blank to use default', 'magone-lite'),
		'type' => 'url'
	),
	'title_icon' => array(
		'label' => esc_html__('Title FontAwesome Icon Code', 'magone-lite'), 
		'description' => wp_kses(
			sprintf(__('Example: fa-home. <a href="%s" target="_blank">Check Full List of Icon Codes Here</a>', 'magone-lite'), esc_url('http://fortawesome.github.io/Font-Awesome/icons/')),
			array(
				'a' => array(
					'href' => array(),
					'target' => array()
	...
	'title_bg_color' => array(
		'label' => esc_html__('Title Background Color', 'magone-lite'), 
		'description' => esc_html__('Leave blank to use transparent', 'magone-lite'),
		'type' => 'color'
	),
	'title_text_color' => array(
		'label' => esc_html__('Title Text Color', 'magone-lite'), 
		'description' => esc_html__('Leave blank to use default color', 'magone-lite'),		
		'type' => 'color'
	),
	'title_border_bottom_color' => array(
		'label' => esc_html__('Title Border Bottom Color', 'magone-lite'), 
		'description' => esc_html__('Leave blank to to hide', 'magone-lite'),		
		'type' => 'color'
	),
	'main_color' => array(
		'label' => esc_html__('Main Color', 'magone-lite'), 
		'description' => esc_html__('Select the main color of box', 'magone-lite'),
		'type' => 'color', 
		'default' => ''
	),
	'thumb_bg_color' => array(
		'label' => esc_html__('Thumbnail Background Color', 'magone-lite'), 
		'description' => esc_html__('Thumbnail background color', 'magone-lite'),
		'type' => 'color', 
		'default' => ''
	),
	'enable_tab' => array(
		'label' => esc_html__('Connect as Tabs', 'magone-lite'), 
		'description' => esc_html__('All consecutive blocks which were enabled this option will be grouped into a tab', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => false
	),
	'count' => array(
		'label' => esc_html__('Count', 'magone-lite'), 
		'description' => esc_html__('Number of posts will be loaded', 'magone-lite'),
		'type' => 'number', 
		'default' => 6
	),	
	'orderby' => array(
		'label' => esc_html__('Content Orderby', 'magone-lite'), 		
		'type' => 'select', 
		'choices' => array(
			'latest' => esc_html__('Latest', 'magone-lite'), 
			'random' => esc_html__('Random', 'magone-lite'),			
			'comment' => esc_html__('Most Commented', 'magone-lite'),
			'popular' => esc_html__('Popular (Most Viewed)', 'magone-lite'),							
		),
		'default' => 'latest'
	),
	'duration' => array(
		'label' => esc_html__('Date Range', 'magone-lite'), 		
		'description' => esc_html__('Date range limit to load post from base on publish date', 'magone-lite'),
		'type' => 'select', 
		'choices' => array(
			'all' => esc_html__('All Time', 'magone-lite'),
			'year' => esc_html__('Last 365 days', 'magone-lite'), 
			'month' => esc_html__('Last 30 days', 'magone-lite'),			
			'week' => esc_html__('Last 7 days', 'magone-lite'),						
		),
		'default' => 'all'
	),
	'show_view_all' => array(
		'label' => esc_html__('Show View All', 'magone-lite'), 
		'description' => esc_html__('Show View All button. Uncheck to hide', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => true
	),
	'item_title' => array(
		'label' => esc_html__('Item Title', 'magone-lite'), 
		'type' => 'select',
		'choices' => array(
			'in' => esc_html__('In Thumbnail', 'magone-lite'), 
			'out' => esc_html__('Out of Thumbnail', 'magone-lite'),			
			'none' => esc_html__('Not Display', 'magone-lite'),			
		),
		'default' => 'in'
	),
	'cates' => array(
		'label' => esc_html__('Load from Categories', 'magone-lite'),
		'description' => esc_html__('The categories that will be loaded posts from. Leave blank to load from all', 'magone-lite'),
		'type' => 'categories'
	),
	'cate_scenario' => array(
		'label' => esc_html__('Category Scenario', 'magone-lite'), 
		'description' => esc_html__('If you choose many categories to load, what relation between them?', 'magone-lite'),
		'type' => 'select', 
		'default' => 'combination',
		'choices' => array(
//			'separate' => esc_html__('Separate (will display category list to switch)', 'magone-lite'), 			
			'combination' => esc_html__('Combination (posts has one OR more above categories)', 'magone-lite'), 			
			'intersection' => esc_html__('Intersection (posts has ALL above categories)', 'magone-lite'), 
		),
	),	
	'authors' => array(
		'label' => esc_html__('Load from Authors', 'magone-lite'),
		'description' => esc_html__('The authors that will be loaded posts from. Leave blank to load from all', 'magone-lite'),
		'type' => 'users'
	),
	'exclude_authors' => array(
		'label' => esc_html__('Exclude Authors', 'magone-lite'),
		'description' => esc_html__('The authors that will not be loaded posts from. Leave blank to load from all', 'magone-lite'),
		'type' => 'users'
	),
	'tags' => array(
		'label' => esc_html__('Load from Tags', 'magone-lite'),
		'description' => esc_html__('The tags that will be loaded posts from. Leave blank to load from all', 'magone-lite'),
		'type' => 'tags'
	),
	'ignore_sticky_posts' => array(
		'label' => esc_html__('Ignore Sticky Posts', 'magone-lite'), 
		'description' => esc_html__('Do not move sticky posts to the start of the set', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => true
	),
	'exclude_loaded_posts' => array(
		'label' => esc_html__('Exclude Loaded Posts', 'magone-lite'), 
		'description' => esc_html__('Do not get the loaded posts from previous blocks', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => false
	),	
	'show_comment' => array(
		'label' => esc_html__('Show Comment', 'magone-lite'), 
		'description' => esc_html__('Show comment number. Uncheck to hide', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => true
	),
	'show_readmore' => array(
		'label' => esc_html__('Show Read More', 'magone-lite'), 
		'description' => esc_html__('Show readmore link. Uncheck to hide', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => true
	),
	'show_author' => array(
		'label' => esc_html__('Show Author', 'magone-lite'), 
		'description' => esc_html__('Show / hide author name in item detail', 'magone-lite'),
		'type' => 'select', 
		'default' => 'icon',
		'choices' => array(
			'none' => esc_html__('Not show', 'magone-lite'), 
			'name' => esc_html__('Show name only', 'magone-lite'), 
			'icon' => esc_html__('Show name with icon', 'magone-lite'), 
			'avatar' => esc_html__('Show name with avatar', 'magone-lite')
		),
	),
	'show_date' => array(
		'label' => esc_html__('Show Date', 'magone-lite'), 
		'description' => esc_html__('Show / hide date / time in item detail. The format will follow the site date time format', 'magone-lite'),
		'type' => 'select', 
		'default' => 'date',
		'choices' => array(
			'none' => esc_html__('Not Show', 'magone-lite'), 
			'full' => esc_html__('Date and Time', 'magone-lite'), 
			'date' => esc_html__('Only Date', 'magone-lite'), 
			'time' => esc_html__('Only Time', 'magone-lite'), 
			'short' => esc_html__('Short Date Time', 'magone-lite'), 
			'pretty' => esc_html__('Pretty Date Time', 'magone-lite')
		)
	),
	'meta_item_order' => array(
		'label' => esc_html__('Meta Item Order', 'magone-lite'), 
		'description' => esc_html__('Pick order for meta items: comment, date, author', 'magone-lite'),
		'type' => 'select', 
		'default' => 'a_c_d',
		'choices' => array(
			'c_d_a' => esc_html__('Comment - Date - Author', 'magone-lite'), 
			'c_a_d' => esc_html__('Comment - Author - Date', 'magone-lite'), 
			'a_c_d' => esc_html__('Author - Comment - Date', 'magone-lite'), 
			'a_d_c' => esc_html__('Author - Date - Comment', 'magone-lite'), 
			'd_a_c' => esc_html__('Date - Author - Comment', 'magone-lite'), 
			'd_c_a' => esc_html__('Date - Comment - Author', 'magone-lite'), 					
		)
	),
	
	'show_format_icon' => array(
		'label' => esc_html__('Show Format Icon', 'magone-lite'), 
		'description' => esc_html__('Show format icon when mouse hover an item of box', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => false
	),	
	'number_cates' => array(
		'label' => esc_html__('Number Categories', 'magone-lite'), 
		'description' => esc_html__('Number categories name will be displayed in each item. Set to 0 to hide', 'magone-lite'),
		'type' => 'range', 
		'max' => 4,
		'default' => 1
	),
	'snippet_length' => array(
		'label' => esc_html__('Snippet Length', 'magone-lite'), 
		'description' => esc_html__('Snippet / excerpt length. Input 0 to hide', 'magone-lite'),
		'type' => 'range', 
		'max' => 500,
		'default' => 150
	),
	'thumbnail_height' => array(
		'label' => esc_html__('Thumbnail Height', 'magone-lite'), 
		'description' => esc_html__('Thumbnail image height. Set to 0 and the box will show image as natural height without cropping', 'magone-lite'),
		'type' => 'range', 
		'max' => 800,
		'default' => 185
	),
	'pagination' => array(
		'label' => esc_html__('Pagination', 'magone-lite'), 		
		'type' => 'select', 
		'choices' => array(
			'' => esc_html__('None', 'magone-lite'), 
			'number' => esc_html__('Number', 'magone-lite'), 
			'loadmore' => esc_html__('Loadmore', 'magone-lite'), 
			'nextprev' => esc_html__('Next / Previous', 'magone-lite')
		),
		'default' => ''
	),
	...
	'rainbow_thumb_bg' => array(
		'label' => esc_html__('Show Rainbow Thumbnail Background Color', 'magone-lite'), 
		'description' => esc_html__('Regardless the Thumbnail Background Color option, just using random colors instead', 'magone-lite'),
		'type' => 'checkbox', 
		'default' => false
	),
);
...
$MagOne_Article_Fields['slider']['show_nav'] = array(
	'label' => esc_html__('Show Navigate Buttons', 'magone-lite'), 
	'description' => esc_html__('The arrow buttons which allow user navigate slides', 'magone-lite'), 
	'type' => 'checkbox', 
	'default' => true
);
$MagOne_Article_Fields['slider']['show_dots'] = array(
	'label' => esc_html__('Show Dot Buttons', 'magone-lite'), 
	'description' => esc_html__('The dot buttons which allow user navigate slides', 'magone-lite'), 
	'type' => 'checkbox', 
	'default' => true
);
$MagOne_Article_Fields['slider']['speed'] = array(
	'label' => esc_html__('Speed', 'magone-lite'), 
	'description' => esc_html__('The animate speed in miliseconds', 'magone-lite'), 
	'type' => 'number',
	'default' => 5000
);
...
$MagOne_Article_Fields['slider']['thumbnail_height']['description'] = esc_html__('Thumbnail Image Height. If the image not fit in thumbnail window, it will be cropped', 'magone-lite');

// carousel
$MagOne_Article_Fields['carousel'] = $MagOne_Article_Fields['slider'];
$MagOne_Article_Fields['carousel']['column'] = array(
	'label' => esc_html__('Number Column', 'magone-lite'), 
	'description' => esc_html__('Number column of carousel', 'magone-lite'),
	'type' => 'range', 
	'min' => 1,
	'max' => 10,
	'default' => 2
...
$MagOne_Article_Fields['two']['no_spacing'] = array(
	'label' => esc_html__('No Spacing', 'magone-lite'), 
	'description' => esc_html__('Disable Spacing Between Items', 'magone-lite'),
	'type' => 'checkbox', 
	'default' => false
);
...
$MagOne_Article_Fields['list']['show_index'] = array(
	'label' => esc_html__('Show Index', 'magone-lite'), 
	'description' => esc_html__('Show index number before each item', 'magone-lite'),
	'type' => 'checkbox', 
	'default' => false
);
...
class MagOne_Article_Item {
	...
	function __construct($args = array()) {
		$this->id = get_the_ID();
		$this->link = esc_url(get_permalink());
		...
		$this->args = $args;
		$this->has_thumbnail = magone_lite_get_post_img_src();		
	...
	function snippet($length = -1, $wrap = 'div') {
		...
		return '<'.$wrap.' class="item-snippet">'. esc_html( magone_lite_get_the_snippet( $length, true ) ) . '</'.$wrap.'>';
	}
	...
	function thumbnail($size = 'thumbnail', $inner = false, $default = true) {		
		...
		$thumbnail = magone_lite_get_post_image(
			$this->id, 
			$size, 
			array(
				'alt' => $this->title_attr, 
		...
		if (!$thumbnail) {
			if ($default) {
				$thumbnail = '<img src="'.esc_url(get_theme_mod('default_post_thumbnail', get_theme_file_uri('/assets/images/default-slider-thumbnail.jpg'))).'" alt="'.esc_attr($this->title_attr).'" title="'.esc_attr($this->title_attr).'"/>';
			} else {
				return '';
			}			
		}
	...
	function title($wrap_tag = 'h3', $class = 'item-title') {		
		...
		$sticky_icon = '';		
		if ( is_sticky($this->id) && is_home() && $this->args['type'] == 'blogging') :
			$sticky_icon = '<span class="sticky-icon"><i class="fa fa-thumb-tack"></i></span> ';
		endif;
		...
		$ret .= $sticky_icon . '<a href="'.esc_url($this->link).'" title="'. esc_attr($this->title_attr).'"';
		if ($wrap_tag == '' || $wrap_tag == 'a') {
	...
	function author() {	
		...
		$avatar = get_avatar($id, 16, '', sprintf(esc_attr__("%s 's Author avatar", 'magone-lite'), $name));
	...
	function date_time() {		
		...
		switch ($this->args['show_date']) {
			case 'pretty':
				$ret .= sprintf( esc_html__( '%s ago', 'magone-lite' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) );
				break;
	...
	function readmore() {
		if ($this->args['show_readmore']) {			
			return '<div class="item-readmore-wrapper"><a class="item-readmore" href="'.esc_url($this->link).'#more">'.esc_html__('Read More', 'magone-lite').'</a></div>';
		}
		return '';
	}
...
function magone_lite_article_box_content($widget_id, $type = '', $atts = array(), $content = '', $cate_ids = array(), $cates = array()) {	
	...
	if ($widget_id != 'magone-archive-blog-rolls') {
		...
		$view_meta_key = MAGONE_META_KEY_VIEWS;
	...
	if ($entries->have_posts()) :		
		while ( $entries->have_posts() ) : $entries->the_post();
			...
			switch ($type) {
				...
				case 'blogging':
					$e->has_thumbnail = magone_lite_get_post_img_src( $e->id, 'thumbnail' );
					$thumb_size = 'full';
					if ($i == 0 && isset($e->args['thumbnail_height']) && ($e->args['thumbnail_height'] == 'auto' || $e->args['thumbnail_height'] == 0)) {
						$thumb_size = 'natural-medium';
					}
					...
					$ret .= '<div '.$e->item_class($i, (!$e->has_thumbnail)?' no-thumbnail': '').'>'
						...
						.			$e->cates()
						.			$e->title()
						.			(is_search() && get_post_type($e->id) == 'page' ? '' : $e->meta())
						...
						'<div class="tr">'.
							...
							'<div class="td">'.
								'<h3 class="item-title">'.									
										...
										'<a href="'.esc_url($e->link).'"><span class="title-name">'. wp_kses($e->title, array()).'</span></a>'.
		...
		$ret = esc_html__('Not found any post', 'magone-lite');
	endif;
	wp_reset_postdata();
	return $ret;
}
...
global $widget_id;
$widget_id = 0;
function magone_lite_article_box($type = '', $atts = array(), $content = '', $label_widget_id = '') {
	...
	if ($atts['title']) {
		...
		if (count($cates) == 1) {
			...
			if ($atts['show_view_all'] && $atts['orderby'] == 'latest' && $atts['tags'] == ''  && $atts['authors'] == '') {
				$hh_3 .= '<div class="feed-widget-viewall"><a href="'.esc_url($cates[0]->link).'"><span>'.esc_html__('VIEW ALL', 'magone-lite').'</span> <i class="fa fa-chevron-right"></i></a></div>';		
			}
			...
			if ($atts['title_url']) {
				...
				$hh_1 .= '<a href="'.  esc_url(home_url()).'/?p=*"'.$text_color.'>'.$title_icon.$atts['title'].'</a>';
			} else {
				$hh_1 .= '<span'.$text_color.'>'.$title_icon.$atts['title'].'</span>';
			}
						
			if ($atts['show_view_all'] && $atts['orderby'] == 'latest' && $atts['tags'] == ''  && $atts['authors'] == '') {
				$hh_3 .= '<div class="feed-widget-viewall"><a href="'.  esc_url(home_url()).'/?p=*">'.esc_html__('VIEW ALL', 'magone-lite').' <i class="fa fa-chevron-right"></i></a></div>';			
	...
	$html .= magone_lite_article_box_content($label_widget_id, $type, $atts, $content, $cate_ids, $cates);	
...
function magone_lite_singular_meta_item_author($author_link = '', $author_name = '', $author_avatar = '') {
	?>

 ...
 */
class Classic_Blog_Dropdown_Taxonomies_Control extends WP_Customize_Control
{
 ...
 * @see WP_Customize_Control
 */
class classic_blog_Radio_Image_Control extends WP_Customize_Control
{
...
if (!function_exists('classic_blog_is_select_page_slider')) :
     ...
     */
    function classic_blog_is_select_page_slider($control)
    {
...
if (!function_exists('classic_blog_is_select_cat_slider')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function classic_blog_is_select_cat_slider($control)
    {
...
if (!function_exists('classic_blog_sanitize_select')) :
     ...
     */
    function classic_blog_sanitize_select($input, $setting)
    {
...
if (!function_exists('classic_blog_sanitize_checkbox')) :
     ...
     */
    function classic_blog_sanitize_checkbox($checked)
    {
...
if (!function_exists('classic_blog_sanitize_positive_integer')) :
     ...
     */
    function classic_blog_sanitize_positive_integer($input, $setting)
    {
...
if (!function_exists('classic_blog_sanitize_dropdown_pages')) :
     ...
     */
    function classic_blog_sanitize_dropdown_pages($page_id, $setting)
    {
...
if (!function_exists('classic_blog_sanitize_image')) :
     ...
     */
    function classic_blog_sanitize_image($image, $setting)
    {
...
if (!function_exists('classic_blog_sanitize_number_range')) :
     ...
     */
    function classic_blog_sanitize_number_range($input, $setting)
    {
 ...
 * @access public
 */
class classic_blog_Customize_Section_Upsell extends WP_Customize_Section {

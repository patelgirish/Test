...
if (!function_exists('classic_blog_get_option')):
 ...
 */
function classic_blog_get_option($key) {
...
$classic_blog_google_fonts = array(
...
function classic_blog_customize_register($wp_customize) {
    ...
    $wp_customize->register_section_type( 'classic_blog_Customize_Section_Upsell' );

// Register sections.
    $wp_customize->add_section(new classic_blog_Customize_Section_Upsell(
            $wp_customize,
            'theme_upsell',
            array(
                'title'    => esc_html__( 'Classic Blog Plus', 'classic-blog' ),
                'pro_text' => esc_html__( 'Buy Pro', 'classic-blog' ),
                'pro_url'  => 'https://unitedtheme.com/themes/classic-blog-plus/',
                'priority'  => 1,
            )
        )
    );
...
function classic_blog_customize_preview_js() {
	...
	wp_enqueue_script('classic_blog_customizer', get_template_directory_uri().'/js/customizer.js', array('customize-preview'), '20130508', true);

}

add_action('customize_preview_init', 'classic_blog_customize_preview_js');

function classic_blog_upsell_js() {
    wp_enqueue_script( 'classic_blog_customize_controls', get_template_directory_uri() . '/assets/js/upsell.js', array( 'customize-controls' ) );
}
add_action( 'customize_controls_enqueue_scripts', 'classic_blog_upsell_js',0 );
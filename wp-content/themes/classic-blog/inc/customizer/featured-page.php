...
$wp_customize->add_section('featured_page_settings',
    array(
        'title'      => esc_html__('Featured Page Options', 'classic-blog'),
        'priority'   => 100,
...
$wp_customize->add_control('enable_featured_page_section',
    array(
        'label'    => esc_html__('Enable Featured Page', 'classic-blog'),
...
$wp_customize->add_control('select_featured_page', array(
        ...
        'label'           => esc_html__('Select Featured Page from', 'classic-blog'),
        'section'         => 'featured_page_settings',
        'type'            => 'dropdown-pages',
        'priority'        => 110,
    )
...
$wp_customize->add_control('featured_page_button_text',
    array(
        'label'    => esc_html__('Section Button Text', 'classic-blog'),
        'section'  => 'featured_page_settings',
        'type'     => 'text',
        'priority' => 120,
    )
...
$wp_customize->add_control('featured_page_additional_button_text',
    array(
        'label'    => esc_html__('Additional Button Text', 'classic-blog'),
        'section'  => 'featured_page_settings',
        'type'     => 'text',
        'priority' => 120,
    )
...
$wp_customize->add_control('featured_page_additional_button_link',
    array(
        'label'    => esc_html__('Additional Button URL', 'classic-blog'),
        'section'  => 'featured_page_settings',
        'type'     => 'text',
        'priority' => 120,
    )

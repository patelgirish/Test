		...
		<div class="row" id="copyright-note">
			<span>
				...
				<span class="footer-info-right">
					<?php echo __(' | Theme Design by', 'landing-pageasy') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'landing-pageasy'); ?>" rel="designer"><?php echo __('SuperbThemes.com', 'landing-pageasy') ?></a>
				</span>
